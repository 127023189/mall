package org.yixi.mallcore.system;

import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.core.env.Environment;
import org.springframework.stereotype.Component;
import org.yixi.mallcore.utils.SystemInfoPrinter;
...
class SystemInistService {
    ...
    @Autowired
    private LitemallSystemService systemService;
    ...
    private Map<String, String> getSystemInfo() {
        ...
        infos.put("调试级别", environment.getProperty("logging.level.org.yixi.litemall.wx"));
